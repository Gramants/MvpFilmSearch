 ...
 */
public class WebViewDialogMyCV extends DialogFragment {

    public static WebViewDialogMyCV create(boolean darkTheme, int accentColor) {
        WebViewDialogMyCV dialog = new WebViewDialogMyCV();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        try {
            customView = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_cv, null);
        } catch (InflateException e) {
            throw new IllegalStateException("This device does not support Web Views.");
        }
        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                .theme(getArguments().getBoolean("dark_theme") ? Theme.DARK : Theme.LIGHT)
                .title(R.string.mycvtit)
        ...
        try {
            ...
            InputStream json = getActivity().getAssets().open("mycv.html");
